...
- # [[DevOps - 1] - Basic. Git](https://rebrainme.com/devops/)
  ...
  - [x] GIT 04: Описание репозитория в README.md
...
* Полезные ссылки:
  ...
  * [Онлайн-сервис для генерации gitignore в разных ситуациях](https://www.toptal.com/developers/gitignore)
* Итоги:
  * В корне проекта появился файл .gitignore
...
## Памятка по созданию нового единственного простейшего файла .gitignore
```bash
echo 'tmp/' >> .gitignore
mkdir tmp
echo 'This file will be ignored like all others in this directory' >> tmp/ignoredfile
echo 'This file will be added' >> addedfile
git add .
git commit
git push -u originbitbucket
```
